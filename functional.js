...
//doubles: String#Includes version
function doublesInclude(elements) {
  return elements.filter(element => !!element.includes("Dakota"));
}
console.log(doublesInclude(states));

//doubles: WhiteSpace version
function doublesWhiteSpace(elements) {
  return elements.filter(element => element.split(/\s+/).length === 2);
}
console.log(doublesWhiteSpace(states));
